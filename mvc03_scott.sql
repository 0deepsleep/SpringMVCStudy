...
VALUES (MEMBERLISTSEQ.NEXTVAL, '조수연', '010-1111-1111');
--> 한 줄 구성 
INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE) VALUES (MEMBERLISTSEQ.NEXTVAL, '조수연', '010-1111-1111')
;
--==>> 1 행 이(가) 삽입되었습니다.

INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE) VALUES (MEMBERLISTSEQ.NEXTVAL, '한승원', '010-1212-1212')
;
--==>> 1 행 이(가) 삽입되었습니다.
